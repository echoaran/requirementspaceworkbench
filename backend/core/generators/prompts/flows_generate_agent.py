    ...
    "flows": [
        {
            ...
            "flow_steps": [
                ...
                },
                {
                    ...
                    "input_business_object_numbers": ["B-001", "B-003"],
                    "output_business_object_numbers": ["B-001"],
                    "next_steps": ["S-003", "S-004", "S-005", "S-006", "S-007"]
                },
                {
                    "step_number": "S-003",
                    "step_name": "编辑便签内容",
        ...
        },
        {
            ...
            "flow_steps": [
                ...
                },
                {
                    ...
                    "actor_ids": [1],
                    "step_type": "actorAction",
                    "input_business_object_numbers": ["B-003", "B-001"],
                    "output_business_object_numbers": ["B-003", "B-001"],
