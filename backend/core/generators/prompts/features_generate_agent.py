...
# 注意
1. 整个features（特征树）为三层结构。
2. 根结点的feature_name为即为系统名称；根结点的feature_description为即为系统简要描述。
3. 中间层级的结点（根结点的子结点）更类似于系统包含的功能，叶子结点则偏向于具体的feature。
...
# 输出格式说明
{
    "features":[
        {
            "feature_number": "<功能编号：例如F-001>", 
            "feature_name": "<功能名字>", 
            "feature_description": "<功能描述>", 
            "actor_ids": ["<相关参与者1的id>", "<相关参与者2的id>", ...(可为空)], 
            "sub_feature_number": List[str] = ["<子feature1的编号>", "<子feature2的编号>", ...(可为空，表示叶子)]
        }, 
        {
            "feature_number": "<功能编号：例如F-001-001>", 
            "feature_name": "<功能名字>",  
            "feature_description": "<功能描述>", 
            "actor_ids": [<相关参与者1的id>, <相关参与者2的id>, ...(可为空)]
            "sub_feature_number": List[str] = ["<子feature1的编号>", "<子feature2的编号>", ...(可为空，表示叶子)], 
    ...
    "features": [
        {
            ...
            "actor_ids": [1],
            "sub_feature_number": ["F001-001", "F001-002", "F001-003"]
        },
        {
            ...
            "actor_ids": [1],
            "sub_feature_number": ["F001-001-001", "F001-001-002", "F001-001-003"]
        },
        {
        ...
        },
        {
            ...
            "actor_ids": [1],
            "sub_feature_number": ["F001-002-001", "F001-002-002", "F001-002-003"]
        },
        {
        ...
        },
        {
            ...
            "actor_ids": [1],
            "sub_feature_number": ["F001-003-001", "F001-003-002", "F001-003-003"]
        },
        {
